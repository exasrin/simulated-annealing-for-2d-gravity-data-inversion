...
% Model Sintetik
f = load("square model.dat");
f = f(:,2)
V = xlsread("model.xlsx")
VV = V(:);
...
figure(1)
subplot(2,1,1); 
plot(x,GG*1e5,'ro-','LineWidth',2.0,'MarkerSize',3); hold on
subplot(2,1,1); 
plot(x,f,'bo-','LineWidth',2.0,'MarkerSize',3);
...
hleg= legend('Inversi SA','G-obs','Location','NorthEast');
...
% dlmwrite('square model.dat',hasil,'newline','pc','delimiter','\t','precision','%10.5f');